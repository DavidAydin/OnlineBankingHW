...
public class BrowserUtils {
    ...
    /**
     * checks if the actual list contains all the values of expected list
     *
     * @param actualList
     * @param expectedList
     * @return
    ...
    public static boolean doesListContainsList(List<String> actualList, List<String> expectedList){
        boolean result = true;
